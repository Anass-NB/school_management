                        ...
                        <td>
                          <div class="dropdown show">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                              ...
                              <a class="dropdown-item" href="{{ route('fees-ivoices.show', $student->id) }}"><i
                                  style="color: #0000cc" class="fa fa-edit"></i>&nbsp;اضافة [فاتورة رسوم&nbsp;</a>
                              ...
                              <a class="dropdown-item" data-target="#Delete_Student{{ $student->id }}"
                                data-toggle="modal" href="##Delete_Student{{ $student->id }}"><i style="color: red"
                                  class="fa fa-trash"></i>&nbsp; حذف بيانات الطالب</a>
                            </div>
                          </div>
                        </td>
                      </tr>
