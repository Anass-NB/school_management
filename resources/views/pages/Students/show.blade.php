            ...
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                <a class="nav-link active show" id="home-02-tab" data-toggle="tab" href="#home-02" role="tab"
                  aria-controls="home-02" aria-selected="true">{{ trans('Students_trans.Student_details') }}</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="profile-02-tab" data-toggle="tab" href="#profile-02" role="tab"
                  aria-controls="profile-02" aria-selected="false">{{ trans('Students_trans.Attachments') }}</a>
              </li>
            </ul>
                  ...
                  <table class="table center-aligned-table mb-0 table table-hover" style="text-align:center">
                    ...
                    <tbody>
                      ...
                      @forelse ($Student->images as $attachment)
                        <tr style='text-align:center;vertical-align:middle'>
                          ...
                          <td colspan="2">
                            <a class="btn btn-outline-info btn-sm"
                              href="{{ url('download-attachment') }}/{{ $Student->name }}/{{ $attachment->filename }}"
                            ...
                            <form action="{{ route('delete.attachment') }}" method="POST">
                              ...
                              <input type="hidden" name="attachment_name" value="{{ $attachment->filename }}">
                              <input type="hidden" name="student_name" value="{{ $Student->name }}">
                        ...
                        {{-- delete with verification ok or close --}}
                              ...
                              <div class="modal-body">
                                <form action="{{ route('Delete_attachment') }}" method="post">
                                  ...
                                  <h5 style="font-family: 'Cairo', sans-serif;">
                                    {{ trans('Students_trans.Delete_attachment_tilte') }}</h5>
                      ...
                      @empty
                        <p class="lead text-danger">No attachment Found !</p>
                      @endforelse
                    </tbody>
                  </table>
                </div>
