                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          ...
                                          <form action="{{ route('update-section', 'test') }}" method="POST">
                                            @csrf
                                            @method('patch')
                                            <div class="row">
                                              <div class="col">
                                            ...
                                            <div class="col">
                                              ...
                                              <select name="Class_id" class="custom-select">
                                                <option value="{{ $list_Sections->My_class->id }}">
                                  ...
                                  <div class="modal fade" id="delete{{ $list_Sections->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form action="{{ route('delete_section', 'test') }}" method="post">
                                            @method('delete')
                                            @csrf
...
<script>
  $(document).ready(function() {
    $('select[name="Grade_id"]').on('change', function() {
      ...
      if (Grade_id) {
        $.ajax({
          url: "{{ URL::to('get-class') }}/" + Grade_id,
          type: "get",
          dataType: "json",
          success: function(data) {
            $("#class_name_id").empty();
            $.each(data, function(k, v) {
              $("#class_name_id").append('<option value="' + k + '">' + v + '</option>');
