  ...
  <div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
      <div class="card-body">
        ...
        <button type="button" class="button x-small" data-toggle="modal" onclick="deletePost()">
        ...
        <form action="{{ route('filter_class') }}" method="POST">
          ...
          <select class="selectpicker" data-style="btn-info" name="Grade_id" required onchange="this.form.submit()">
            <option value="testt" selected disabled>{{ trans('My_Classes_trans.Search_By_Grade') }}</option>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              ...
                              <input type="text" class="form-control"
                                value="{{ $My_Class->getTranslation('Name_Class', 'en') }}" name="Name_en" required>
                            </div>
                          </div><br>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class=" row mb-30" action="{{ route('store_class') }}" method="post">
            @csrf
            <div class="card-body">
              <div class="repeater">
                <div data-repeater-list="List_Classes">
                  <div data-repeater-item>
                    <div class="row">
                      ...
                      <div class="col">
                        <label for="Name" class="mr-sm-2">{{ trans('Sections_trans.Name_Class') }}
                          :</label>
...
<!-- حذف مجموعة صفوف -->
<div class="modal fade" id="delete_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<script>
  function deletePost() {
    let mybtn = document.getElementById("btn_delete_all");
    let chks = document.querySelectorAll(".box1");
    let inp = document.getElementById("delete_all_id");
    let inp2 = " ";
    chks.forEach(chk => {
      if (chk.checked) {
        inp2 += chk.value + " ";
        let st = ".row" + chk.value;
