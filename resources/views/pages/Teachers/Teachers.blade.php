    ...
    <div class="card card-statistics h-100">
      <div class="card-body">
        <div class="col-xl-12 mb-30">
          <div class="card card-statistics h-100">
            <div class="card-body">
              <a href="{{ route('create_teacher') }}" class="btn btn-success btn-sm" role="button"
                  ...
                  <tbody>
                    ...
                    @foreach ($Teachers as $Teacher)
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('edit_teacher', $Teacher->id) }}" class="btn btn-info btn-sm"
                      ...
                      <div class="modal fade" id="delete_Teacher{{ $Teacher->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                          <form action="{{ route('delete_teacher', 'test') }}" method="post">
                            @method("delete")
                            @csrf
