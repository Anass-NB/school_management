        ...
        <ul class="nav navbar-nav side-menu" id="sidebarnav">
          ...
          <li>
            ...
            <ul id="Grades-menu" class="collapse" data-parent="#sidebarnav">
              <li><a href="{{ route('grade') }}">{{ trans('main_trans.Grades_list') }}</a></li>
          ...
          <li>
            ...
            <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
              <li><a href="{{ route('classrooms') }}">{{ trans('main_trans.List_classes') }}</a></li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
              <li><a href="{{ route('all-sections') }}">{{ trans('main_trans.List_sections') }}</a></li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul id="students-menu" class="collapse">
              ...
              <li>
                <a href="javascript:void(0);" data-toggle="collapse"
                  data-target="#Students_upgrade">{{ trans('main_trans.Students_Promotions') }}<div class="pull-right">
                    <i class="ti-plus"></i>
                  </div>
                  <div class="clearfix"></div>
                </a>
              ...
              <li>
                <a href="javascript:void(0);" data-toggle="collapse"
                  data-target="#Graduate students">{{ trans('main_trans.Graduate_students') }}<div class="pull-right">
                    <i class="ti-plus"></i>
                  </div>
                  <div class="clearfix"></div>
                </a>
                <ul id="Graduate students" class="collapse">
                  <li> <a href="{{ route('graduating.create') }}">{{ trans('main_trans.add_Graduate') }}</a> </li>
                  <li> <a href="{{ route('graduating.index') }}">{{ trans('main_trans.list_Graduate') }}</a> </li>
                </ul>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
              ...
              <li> <a href="{{ route('fees-ivoices.index') }}">الفواتير</a> </li>
